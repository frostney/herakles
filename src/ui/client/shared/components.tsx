...
export function closeModalOnEscape(
  event: KeyboardEvent,
  escapeCloses: boolean,
  onClose: () => void,
) {
...
export function trapModalTab(event: KeyboardEvent, dialog: HTMLElement | null) {
...
export function wrapModalFocus(
  event: KeyboardEvent,
...
export function upExecutionTone(status: UpRunResult[number]["status"]): BadgeTone {
