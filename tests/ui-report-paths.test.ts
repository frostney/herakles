...
describe("UI report paths", () => {
  test("extracts report ids from absolute and workspace-relative report paths", () => {
    expect(reportIdFromPath("/workspace/_herakles/reports/evening/2026-06-12.md")).toBe(
      "evening/2026-06-12.md",
    );
    expect(reportIdFromPath("_herakles/reports/coderabbit/review.md")).toBe("coderabbit/review.md");
    expect(reportIdFromPath("C:\\Code\\_herakles\\reports\\weekly\\2026-W24.md")).toBe(
      "weekly/2026-W24.md",
    );
  });
